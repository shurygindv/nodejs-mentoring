...
export interface IGroupsService {
    ...
    editGroupById(id: guidV4, groupModel: GroupModel): Promise<GroupModel>;
    deleteGroupById(id: guidV4): Promise<GroupModel>;
}

@injectable()
export class GroupsService extends BaseService implements IGroupsService {
    @inject(groupTokens.groupsRepository)
    private groupRepository: IGroupsRepository;
    @inject(groupTokens.groupDboMapper)
    private groupMapper: GroupModelDboMapper;
    ...
    public async getGroupById(id: guidV4): Promise<TS.MaybeNull<GroupModel>> {
    ...
    public async deleteGroupById(id: guidV4): Promise<GroupModel> {
